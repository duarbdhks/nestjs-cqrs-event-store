...
let EventStoreConfiguration = class EventStoreConfiguration {
    get config() {
        return {
            hostname: config_1.config.event_store.host,
            port: config_1.config.event_store.tcp_port,
            credentials: {
                username: config_1.config.event_store.username,
                password: config_1.config.event_store.password,
            }
        };
    }
};
